...
- **Muse Code CLI support (`muse`).** Meta's terminal coding agent joins The Pair as a tenth provider, driven by `muse exec --json`. Verified against Muse Code 1.0.3 (2026-09-19) — note the published docs still name `muse-spark-1.2` as the default while the shipped binary uses `muse-spark-1.3`.
